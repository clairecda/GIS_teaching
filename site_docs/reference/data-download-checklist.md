...
- [ ] `data/raw/week02/renewable-energy/renewable-energy-data.csv`
...
- [ ] `data/raw/week04/elvis-dem/*.tif` **or** `data/raw/week04/srtm/*.hgt`
- [ ] `data/processed/week04/elvis_dem_clip.tif`

## Week 5 — Crime Case Study

- [ ] `data/raw/week05/nsw-crime/offences_by_lga.csv` (or local crime dataset)
- [ ] `data/raw/week05/nsw-lga/` (boundary shapefile)
...
- [ ] `data/processed/week06/health_services_filtered.csv`
...
- [ ] Latest project layers exported for critique (list filenames in notes)

## Week 12 — Capstone

- [ ] Final dataset inventory updated (use the personal tracking template in the dataset inventory)
- [ ] All project inputs/outputs stored under `data/` with descriptive names
