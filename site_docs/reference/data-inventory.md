...
This table lists datasets used throughout the course, organized by theme. Each entry includes the source, licensing information, and notes about usage. You can use this reference when exploring datasets for your own projects.
...
| Vector analysis | ABS ASGS Edition 3 SA2 boundaries | <https://www.abs.gov.au/statistics/standards/australian-statistical-geography-standard-asgs-edition-3/jul2021-jun2026/access-and-downloads/digital-boundary-files> | CC BY 4.0 | National shapefiles for Week 3 joins. |
| Vector analysis | ABS SEIFA 2021 (SA2 indexes) | <https://www.abs.gov.au/statistics/people/people-and-communities/socio-economic-indexes-areas-seifa-australia/latest-release#data-downloads> | CC BY 4.0 | Provides socio-economic scores; note index and revision. |
...
| Cross-cutting | Esri Living Atlas (selected datasets) | <https://livingatlas.arcgis.com/> | Mixed | Curate downloadable items with permissive licenses; document restrictions. |
...
Use the table below to log datasets you download for labs or your capstone project.

| Dataset | Date acquired | Version / vintage | Local path | Processing steps | Notes |
| ------- | ------------- | ----------------- | ---------- | ---------------- | ----- |

> Keep processed files organized and document your workflow so you can reproduce your work later.
