...
- Download links:
  - **macOS (Apple silicon & Intel):** [Download .dmg installer](https://qgis.org/en/site/forusers/download.html#mac)
  - **Windows:** [Download standalone installer](https://qgis.org/en/site/forusers/download.html#windows) — choose the **Long Term Release (LTR)** option
  - **Linux:** [Installation instructions](https://qgis.org/en/site/forusers/alldownloads.html#linux) — use your distribution's package manager with the LTR channel
