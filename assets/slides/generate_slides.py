...
- Professional blue grey/orange color scheme matching MkDocs theme
...
<head>
  ...
  <style>
    ...
    * {{
    ...
    /* ========== ROOT VARIABLES ========== */
    :root {{
      --primary: #546e7a;        /* Blue Grey - main brand color */
      --primary-dark: #37474f;   /* Dark blue grey */
      --primary-light: #78909c;  /* Light blue grey */
